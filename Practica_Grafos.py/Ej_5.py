...
g.insert_edge('Debian',    'Switch 1', 17)
g.insert_edge('Ubuntu',    'Switch 1', 18)
g.insert_edge('Impresora', 'Switch 1', 22)
g.insert_edge('Mint',      'Switch 1', 80)
...
#B
print("---Punto B---")
print("Barrido profundo para Red Hat")
g.deep_sweep("Red Hat")
print("")

print("Barrido profundo para Debian")
g.deep_sweep("Debian")
print("")

print("Barrido profundo para Arch")
g.deep_sweep("Arch")



print("Barrido amplitude para Red Hat")
g.amplitude_sweep("Red Hat")
print("")

print("Barrido amplitude para Debian")
g.amplitude_sweep("Debian")
print("")

print("Barrido amplitude para Arch")
g.amplitude_sweep("Arch")

#C
print("---Punto C---")
for pc in ["Manjaro", "Red Hat", "Fedora"]:
    camino, costo = camino_minimo(g, pc, "Impresora")
    print(f"\nDesde {pc}:")
    print("  Camino:", camino)
...
print("---Punto E---")
pcs = ["Ubuntu", "Mint", "Fedora", "Manjaro", "Parrot"]
mejor_pc = None
...
for pc in pcs:
    camino, costo = camino_minimo(g, pc, "Guarani")
    print(f"PC: {pc}   costo: {costo}  camino: {camino}")
...
print("La PC con mejor camino a Guaraní es:")
...
nodo_switch1 = g[pos_switch1]


for edge in nodo_switch1.edges:
    nombre = edge.value
    pos = g.search(nombre, "value")
    if pos is not None:
        nodo = g[pos]
        if nodo.tipo == "pc":   
            computadoras_switch1.append(nombre)

print("Computadoras conectadas al Switch 1:", computadoras_switch1)

mejor_pc = None
mejor_costo = float("inf")
mejor_camino = None

for pc in computadoras_switch1:
    camino, costo = camino_minimo(g, pc, "MongoDB")
    print(f"PC: {pc}  -> costo: {costo}  camino: {camino}")
...
print("\nLa computadora del Switch 1 con mejor camino a MongoDB es:")
print(f"   {mejor_pc}  con costo {mejor_costo}")
print(f"   Camino: {mejor_camino}")
...
print("Conexión actualizada: Impresora a Router 2\n")
...
if not g.is_directed:
    print("El grafo es NO dirigido: todas las aristas son bidireccionales.")
else:
    print("ERROR: El grafo es dirigido. Debe ser NO dirigido.")
